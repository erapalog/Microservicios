...
public class Autorizations {
	...
	public static ResponseEntity<?> getResponseDenied(String message) {
		return new ResponseEntity<>(new GeneralResponse(null, Params.CODE_BAD_REQUEST, message),
	...
	public static ResponseEntity<?> getResponseSuccess(Object obj, String message) {
		...
		return new ResponseEntity<>(new GeneralResponse(obj, Params.CODE_OK, message), HttpStatus.OK);
	}
	...
	public static ResponseEntity<?> getResponseBadRequest(Object obj, String message) {
		...
		return new ResponseEntity<>(new GeneralResponse(obj, Params.CODE_BAD_REQUEST, message),
